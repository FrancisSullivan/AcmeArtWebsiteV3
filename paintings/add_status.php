        ...
        <div class="container-fluid">
            ...
            try {
                ...
                if (isset($_POST["submit_button"])) {
                    ...
                    $statement = "INSERT INTO paintings (title, artist_id, style, media, finished, thumbnail, full_pic) VALUES ('$title', '$artist', '$style', '$media', '$finished', '$thumbnail', '$full_pic')";
