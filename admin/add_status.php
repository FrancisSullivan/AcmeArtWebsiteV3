        ...
        <div class="container-fluid">
            ...
            try {
                ...
                if (isset($_POST["submit_button"])) {
                    ...
                    $statement = "INSERT INTO artists (artist_name, lifespan, period, nationality, thumbnail, full_pic) VALUES ('$artist_name', '$lifespan', '$period', '$nationality', '$thumbnail', '$full_pic')";
